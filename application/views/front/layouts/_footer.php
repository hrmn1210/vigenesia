        ...
        <div class="row f_widgets_inner">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="single-footer-widget ab_widgets">
                    ...
                    <p>Vigenesia merupakan portal berita kekinian</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <ul class="list mt-3">
                                ...
                                <li><a href="<?= base_url("blog/category/$c->slug") ?>"><?= $c->category_name ?></a>
                                </li>
                                <?php endforeach ?>
                            </ul>
                        </div>
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            ...
            <p class="col-lg-8 col-md-8 footer-text">
                ...
                document.write(new Date().getFullYear());
                    ...
                    aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Vigenesia</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
        </div>
    </div>
