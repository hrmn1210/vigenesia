        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    ...
                    <div class="form-group row">
                        <label for="article" class="col-sm-2 col-form-label"><span class="text-danger">*</span>
                            Konten</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group row">
                        <div class="col">
                            ...
                            <select class="form-control" id="featured" name="featured">
                                <option value="N" <?php if($input->featured == "N"){ print ' selected'; }?>>Tidak
                                </option>
                        ...
                        <div class="col">
                            <label for="category" class="col-form-label"><span class="text-danger">*</span>
                                Kategori</label>
                            <select class="form-control" id="id_category" name="id_category">
                                <option value="">- Pilih -</option>
                                <?php foreach($category as $c) : ?>
                                <option value="<?= $c->id ?>"
                                    <?php if($c->id == $input->id_category){ print ' selected'; }?>>
                        ...
                        <div class="col">
                            ...
                            <select class="form-control" id="is_active" name="is_active">
                                ...
                                <option value="N" <?php if($input->is_active == "N"){ print ' selected'; }?>>Tidak
                                </option>
                            </select>
                        </div>
                    </div>
    ...
    ClassicEditor
        .create(document.querySelector('#summernote'), {
            toolbar: [
                ...
                'blockQuote', '|',
                'insertTable' // Menghapus imageUpload dari toolbar
            ]
        })
        .then(editor => {
